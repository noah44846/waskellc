...
#let declaration_of_honor(authors, lang) = {
  ...
  for author in authors {
    if lang == "en" [
      ...
      personal effort. I certify that I have not resorted to plagiarism or other forms of fraud. All sources of
      information used and author citations have been clearly acknowledged.
    ] else if lang == "fr" [
